...
class Pedidos extends Component {
    ...
    getApplications() {
        ...
        Axios.get(`projeto-hospital-backend-production.up.railway.app/api/applications`, {
            headers: {
    ...
    onDelete(applicationId) {
        const token = localStorage.getItem('token');
        Axios.delete(`projeto-hospital-backend-production.up.railway.app/api/applications/${applicationId}`, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
    ...
    onUpdate(id) {
        ...
        Axios.put(`projeto-hospital-backend-production.up.railway.app/api/applications/${id}`, {}, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
        }).then(() => this.getApplications());
