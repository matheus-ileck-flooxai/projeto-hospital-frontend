...
class users extends Component {
    ...
    getusers() {
        ...
        Axios.get(`https://projeto-hospital-backend-production.up.railway.appapi/hospital/users`, {
            headers: {
    ...
    onSubmit(e) {
        ...
        if (this.state.User.id) {
            Axios.put(`https://projeto-hospital-backend-production.up.railway.appapi/users/${this.state.User.id}`, User, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            }).then(resp => {
            ...
            Axios.post('https://projeto-hospital-backend-production.up.railway.appapi/users', User, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            })
    ...
    onDelete(id) {
        ...
        Axios.delete(`https://projeto-hospital-backend-production.up.railway.appapi/users/${id}`, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
        }).then(() => this.getusers());
