...
class users extends Component {
    ...
    getusers() {
        ...
        Axios.get(`https://projeto-hospital-frontend.vercel.app/api/hospital/users`, {
            headers: {
    ...
    onSubmit(e) {
        ...
        if (this.state.User.id) {
            Axios.put(`https://projeto-hospital-frontend.vercel.app/api/users/${this.state.User.id}`, User, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            }).then(resp => {
            ...
            Axios.post(`https://projeto-hospital-frontend.vercel.app/api/users`, User, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            })
    ...
    onDelete(id) {
        ...
        Axios.delete(`https://projeto-hospital-frontend.vercel.app/api/users/${id}`, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
        }).then(() => this.getusers());
