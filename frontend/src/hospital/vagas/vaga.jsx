...
class vacancies extends Component {
    ...
    getVacancies() {
        ...
        Axios.get(`https://projeto-hospital-backend-production.up.railway.appapi/hospital/vacancies`, {
            headers: {
    ...
    onSubmit(e) {
        ...
        if (this.state.Vacancy.id) {
            Axios.put(`https://projeto-hospital-backend-production.up.railway.appapi/vacancies/${this.state.Vacancy.id}`, vacancy, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            }).then(resp => {
            ...
            Axios.post('https://projeto-hospital-backend-production.up.railway.appapi/vacancies', vacancy, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            })
    ...
    onDelete(id) {
        ...
        Axios.delete(`https://projeto-hospital-backend-production.up.railway.appapi/vacancies/${id}`, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
    ...
    finishVacancy(id) {
        ...
        Axios.delete(`https://projeto-hospital-backend-production.up.railway.appapi/vacancies/${id}`, status,{
            headers: {
                'Authorization': `Bearer ${token}`
            }
        }).then(() => this.getVacancies());
