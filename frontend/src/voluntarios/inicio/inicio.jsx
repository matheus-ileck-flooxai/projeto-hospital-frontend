...
export default class Inicio extends Component {
    ...
    getLeaderboard() {
        ...
        Axios.get(`https://backend-hospital-production.up.railway.app/api/leaderboard`)
            .then(resp => {
                ...
                <div className="container">
                    ...
                    <section className="vacancies" id="vagas">
                        <div className="row">
                            ...
                            {this.state.vacancies.length > 0 && (<div className="see-more">
                                <a className="btn" href="#/volunteer/vacancies">Clique aqui para visualizar todas as vagas</a>
                            </div>
                            )}
                        </div>
