...
export default class Vagas extends Component {
    ...
    getVacancies() {
        ...
        if (token) {
            ...
            Axios.get(`https://projeto-hospital-frontend.vercel.app/api/vacancies?userId=${userId}`)
                .then(resp => {
            ...
            Axios.get(`https://projeto-hospital-frontend.vercel.app/api/vacancies`)
                .then(resp => {
                    this.setState({ vacancies: resp.data });
                })
                .catch(error => {
    ...
    onsubmit() {
        ...
        if (token && decoded.role == 'Volunteer') {
            ...
            Axios.post(`https://projeto-hospital-frontend.vercel.app/api/volunteer/newapplication`, { userId, vacancyId }, {
                headers: {
